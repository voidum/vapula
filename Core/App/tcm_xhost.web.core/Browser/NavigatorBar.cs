...
{
    public class NavigatorBar : ToolStrip
    {
        ...
        public NavigatorBar()
        {
            ...
            _BtBack.Image = Properties.Resources.back;
            _BtBack.ToolTipText = "Back";

            _BtForward.Image = Properties.Resources.forward;
            _BtForward.ToolTipText = "Forward";

            _BtRefresh.Image = Properties.Resources.refresh;
            _BtRefresh.ToolTipText = "Refresh";

            _BtOption.Image = Properties.Resources.menu;
